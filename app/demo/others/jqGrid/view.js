 ...
 */
define([
    'tpl!app/demo/others/jqGrid/templates/demo.tpl',
    'jquery.jqGrid'
], function(jqGridTpl) {
    ...
    return Marionette.ItemView.extend({
        // TAB唯一标识
        tabId: 'demo.menu.others.jqGrid',

        template: jqGridTpl,

        className: "jqGrid-sample",

        ui: {
            listContainer: '#list',
            pagerContainer: '#pager',
            list1Container: '#list1',
            pager1Container: '#pager1'
        },
        ...
        createJqGrid: function() {
            ...
            var browser = {
                ...
                ui.listContainer.jqGrid({
                    url: url._('demo.api.others.jqGrid.frozen1'),
                    datatype: "json",
