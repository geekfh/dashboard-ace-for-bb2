...
define([
    ...
    var tpl = [
        '<div class="row">',
            '<div class="col-xs-12 jgrid-container">',
                '<table id="demo-page-grid-list1-grid-table"></table>',
                '<div id="demo-page-grid-list1-grid-pager" ></div>',
            '</div>',
        '</div>'
    ].join('');

    //格式化日期格式
    var dateFormatter = function (value, options, rowData) {
    ...
    return Marionette.ItemView.extend({
        // TAB唯一标识
        tabId: 'demo.menu.grid.list1',

        template: _.template(tpl),

        ui: {
            demoTable: '#demo-page-grid-list1-grid-table'
        },
        ...
        renderGrid: function () {
            ...
            me.grid = App.Factory.createJqGrid({
                caption: '优惠方案模型',
                rsId:'demo.pm.grid.list1',
                gid: 'demo-page-grid-list1-grid',
                url: url._('demo.api.grid.list1'),
                autoResize: false,
                overflow: true,
                actionsCol: {
                    view: false
                ...
                gridComplete: function() {
                    _.defer(function() {
                        //me.ui.demoTable.jqGrid("setFrozenColumns");
                    });
                }
            });
        }
