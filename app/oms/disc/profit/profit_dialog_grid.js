/**
 * Created by wupeiying on 2015/7/20.
 */
define([//'App',
    'tpl!app/oms/disc/profit/table-pd-ct.tpl',
    'i18n!app/oms/common/nls/param',
    'jquery.jqGrid',
    'bootstrap-datepicker'
], function( tableCtTpl, paramLang) {//App,
    ...
    var GridView = Backbone.View.extend({
        ...
        tpl: function () {
            ...
            return [
                ...
                '<table id="profit-dialog-grid-',count,'-table"></table>',
                '<div id="profit-dialog-grid-',count,'-pager" ></div>',
                '</div>',
            ].join('');
        },

        gid: function () {
            return 'profit-dialog-grid-' + count;
        },
        ...
        renderGrid: function() {
            ...
            var grid = this.grid = App.Factory.createJqGrid($.extend({
                ...
                //提供一个父级元素来查找
                // elRoot: this.$el,
                rsId: 'profitdialog',//profit-dialog-grid
