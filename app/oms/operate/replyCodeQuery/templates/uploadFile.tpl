    ...
    <div class="terminals-group">
        <form method="post" class="upload-form" action="" enctype="multipart/form-data" style="padding:10px;">
            <div class="form-row">
                ...
                <label class="content-lab">本系统提供的</label>
                <a href="#" class="content-href download-btn">Excel模板</a>
            </div>
            <div class="form-row">
                <div class="row-num">2</div>
                <span class="uploadfile"><label class="content-upload-btn">上传Excel文件</label> </span>
            </div>
            <br>
            <div class="form-row">
                ...
                <span class="uploadFileIndicator">
                    <span class="icon-wrap"><i class="icon-spinner icon-spin"></i> </span>
                    <span class="progress-percent">正在上传...</span>
                </span>
            </div>
        </form>
    </div>
