...
define(['App',
    ...
    App.module('SettleApp.SettleDownload.List', function(View, App, Backbone, Marionette, $, _) {
        ...
        View.brhFeeReport = Marionette.ItemView.extend({
            ...
            renderGrid: function() {
                ...
                var grid = App.Factory.createJqGrid({
                    ...
                    colModel:[
                        ...
                        {name: 'settleBrhCode',             index: 'settleBrhCode', search: true, formatter: settleBrhCodeFormatter},
                        ...
                        {name: 'resultFlag',             index: 'resultFlag'},
