...
%>
<form class="clear-edit-cancelorder">
    ...
    <%if(type !== '3'){%>
        <div class="form-group">
            ...
            <div class="col-xs-7"><span class="form-control"><%=CONTACT_STATUS["1"]%></span></div>
        </div>
    <%}%>
    <%if(type === '2' || type === '5'){%>
        <div class="form-group">
            <label class="control-label col-xs-4">&nbsp;&nbsp;原因码：</label>
            <div class="col-xs-7"><span class="form-control"><%=CANCEL_REASON_CODE[type][cancelReasonCode]%></span></div>
        </div>
    <%}if(type === '2'){%>
        <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-7">
            <input id="refundedAmt" name="refundedAmt" type="text" class="form-control" style="margin: 4px auto" value="<%=refundedAmt || 0%>">
            <span name="refundedAmtInfo" style="color:red;font-size: small;visibility: hidden"></span>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-4">&nbsp;&nbsp;扣款日期：</label>
        <div class="col-xs-7">
            <input name="debitReleaseTime" class="form-control" placeholder="请输入扣款日期" style="margin: 4px auto" value="<%=debitReleaseTime ? debitReleaseTime.substring(0,4)+'年'+debitReleaseTime.substring(5,7)+'月'+debitReleaseTime.substring(8,10)+'日' : '' %>">
            <span name="chargeTimeInfo" style="color:red;font-size: small;visibility: hidden">请输入扣款日期</span>
        </div>
    </div>
    <div class="form-group">
