 ...
 */
define(['App',
    'tpl!app/oms/settle/settle-faster/control/table-ct.tpl',
    ...
    var View = Marionette.ItemView.extend({
        ...
        renderGrid: function () {
            ...
            var roleGird = me.grid = App.Factory.createJqGrid(me.gridOptions({
                    ...
                    multiselect: true,
                    multiboxonly: false,
                    rsId: 'settleFasterControl',
                    caption: '',
                    tableCenterTitle: 'S0控制表',
                    actionsCol: {
                        edit: false,
                        del: false,
                        width: 100,
                    ...
                    gid: 'faster-controls-grid',
                    url: url._('settle.faster.control'),//url 'settle.control'
                    colNames: {
                    ...
                    colModel: [
                        ...
                        {name: 'totalNum', index: 'totalNum', search: false, editable: true},  //总笔数
                        {
                            ...
                            search: false,
                            editable: true,
                            formatter: Opf.currencyFormatter
                        },  //总金额
        ...
        getTransferUrl: function () {
            return 's0settle.ctrl.transfer';
        },

        getCheckUrl: function () {
            return 's0settle.ctrl.check';
        },

        getConfirmUrl: function () {
            return 's0settle.ctrl.confirm';
        },

        getConfirmTUrl: function () {
            return 's0settle.ctrl.confirmT';
        }
    });

    App.on('settleFaster:t0:control:list', function () {
        App.show(new View());
    });
