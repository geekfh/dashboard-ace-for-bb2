...
define([
    ...
    var Collection = OpfPageableCollection.extend({
        ...
        applyFilterSearch: function (strFilters) {
            ...
            this.setUrl(url._('route.filters.mcht'));
    ...
    var ItemView = ModelView.extend({
        permission: {
            'edit': Ctx.avail('route.config.mcht.edit'),
            'del': Ctx.avail('route.config.mcht.del')
        },
        ...
        onEditModel: function (obj) {
            var me = this;
            require(['app/oms/route/oneSettle/mcht-channel/edit-mcht-channel-model-view'], function (ModelView) {
        ...
        onDelModel: function (obj) {
            ...
            Opf.confirm('确认注销？', function (result){
                ...
                Opf.ajax({
                    url: url._('route.filters.mcht', {id: obj.model.get('id')}),
                    type: 'DELETE',
                    success: function () {
    ...
    var ListView = ModelListView.extend({
        ...
        initialize: function () {
            ...
            this.permission = {
                add: Ctx.avail('route.config.mcht.add'),
                upload: Ctx.avail('route.config.mcht.upload')
            };
        },
