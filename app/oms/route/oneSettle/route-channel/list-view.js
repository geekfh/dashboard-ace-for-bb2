define([
    'tpl!app/oms/route/oneSettle/route-channel/templates/table-list.tpl',
    'jquery.jqGrid',
    'common-ui'
], function(tableCtTpl) {
    ...
    var View = Marionette.ItemView.extend({
        ...
        renderGrid: function() {
            ...
            _.defer(function () {
                if(!Ctx.avail('route.channel.grid.editStatus')) {
                    return;
                }
                        ...
                        if(ids.length == 0){
                            ...
                            if(flag){
                                ...
                                callBack.parent().find('[type="submit"]').on('click', function (){
                                    ...
                                    Opf.ajax({
                                        type: 'PUT',
                                        url: 'api/mcht/route/channel-models/bat-update-stat',
                                        jsonData: {
                                            ids: ids,
                                            status: status
                                        },
    ...
    App.on('route:channel:list', function () {
        App.show(new View());
    });
