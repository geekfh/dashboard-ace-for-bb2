define([
    'tpl!app/oms/route/oneSettle/channel-attr-config/templates/table-list.tpl',
    'jquery.jqGrid'
], function(tableCtTpl) {
    ...
    var View = Marionette.ItemView.extend({
        tabId: 'menu.channel.attr.config',
        template: tableCtTpl,
        onRender: function() {
            var me = this;
        ...
        onEditModel: function (id) {
            ...
            require(['app/oms/route/oneSettle/channel-attr-config/edit'], function (EditModelView) {
        ...
        onViewModel: function (id) {
            ...
            require(['app/oms/route/oneSettle/channel-attr-config/detail'], function (ModelView) {
        ...
        onAddModel: function () {
            var me = this;
            require(['app/oms/route/oneSettle/channel-attr-config/add'], function (ModelView) {
        ...
        getDetailDataById: function(id){
            ...
            Opf.ajax({
                type:'GET',
                url:url._('route.channel.config',{'id':id}),
                async:false,
                ...
                click: function () {
                    ...
                    if (oldState != newState) {
                        Opf.ajax({
                            ...
                            url: url._('route.channel.config.upd.status', {id: rowData.id}),
                            successMsg: '更改状态成功',
                            success: function () {
                                me.grid.trigger('reloadGrid', {current: true});
                            },
    ...
    App.on('route:channelConfig:list', function () {
        App.show(new View());
    });
