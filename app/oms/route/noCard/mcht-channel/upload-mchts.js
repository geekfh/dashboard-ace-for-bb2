define([
    'tpl!app/oms/route/noCard/mcht-channel/templates/upload-more-mchts.tpl',
    'upload',
    'common-ui'
], function(tpl) {
    ...
    var View = Marionette.ItemView.extend({
        ...
        getExeclTemplteUrl: function(){
          return url._('route.nocard.download.excel');
        },
        ...
        getUploadUrl: function(){
            return url._('route.nocard.upload');
        },

        addSelects: function (me) {
            CommonUI.noCradChannelName(me.$el.find('[name="channelName"]'));
        }, 
