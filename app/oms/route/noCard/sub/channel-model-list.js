define([
    ...
    var ItemView = ModelView.extend({
        permission: {
            'edit': Ctx.avail('nocard.route.config.channel.edit'),
            'del': Ctx.avail('nocard.route.config.channel.del')
        },
        ...
        onDelModel: function (obj) {
            ...
            Opf.confirm('确认删除？', function (result){
                ...
                Opf.ajax({
                    url: url._('nocard.route.channel', {id: obj.model.get('id')}),
                    type: 'DELETE',
                    success: function () {
    ...
    var ListView = ModelListView.extend({
        ...
        initialize: function () {
            ...
            this.permission = {
                add: Ctx.avail('nocard.route.config.channel.add')
            };
        },
