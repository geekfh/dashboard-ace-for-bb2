define([
    'tpl!app/oms/route/noCard/route-mcht/templates/table-list.tpl',
    ...
    var View = Marionette.ItemView.extend({
        ...
        onEditModel: function (obj) {
            ...
            require(['app/oms/route/noCard/mcht-channel/edit-mcht-channel-model-view'], function (EditModelView) {
        ...
        requestBatchOpenOrClose: function (options) {
            ...
            if (this.selectType === SELECT_TYPE.SEL_ALL) {
                ...
                me.ajaxBatchOperate(url._('batch.nocard.open.close.filters'), submitData).done(function (resp) {
                    if (resp.success !== false) {
                        me.ajaxSuccess();
                    }
                });
        ...
        deleteMchtData: function (rowData) {
            ...
            $.ajax({
                type: 'DELETE',
                url: url._('route.nocard.filters.mcht', {id: rowData.id}),
                complete: function () {
                    me.grid.trigger('reloadGrid', {current: true});
                }
            });
        ...
        renderGrid: function() {
            ...
            me.grid = App.Factory.createJqGrid({
                ...
                gid: 'nocard-route-mcht-grid',
                url: url._('route.nocard.filters.mcht'),
                ...
                colModel: [
                    ...
                    {name: 'scanMode', formatter: scanModeFormatter},
    ...
    function scanModeFormatter (val) {
        return SCANMODE_MAP[val] || '';
    }
    ...
    App.on('route:nocard:mcht:list', function () {
        App.show(new View());
    });
