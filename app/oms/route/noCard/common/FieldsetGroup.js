define([
    'tpl!app/oms/route/noCard/common/templates/add-field-item.tpl',
    'tpl!app/oms/route/noCard/common/templates/fieldset-group.tpl',
    'tpl!app/oms/route/noCard/common/templates/field-types-dd.tpl',
    'tpl!assets/scripts/fwk/component/templates/area-no.tpl',
    'app/oms/route/noCard/common/AbstarctField',
    'bootstrap-tagsinput',
    'jquery.inputmask',
    'select2',
    'common-ui'

], function(addFieldItemTpl, fieldsetGroupTpl, fieldTypesDDTpl, areaTpl, AbstarctField) {
    ...
    var ScanMode = AbstarctField.extend({
        label: '扫码模式',
        name: 'scan_mode',
        extraOprs: ['in', 'not_in'],
        select2Data: [{id: '1', text: '主扫'}, {id: '2', text: '被扫'},{id: '3',text: '主扫和被扫'},{id: '4',text: '二维码'},{id: '5',text: '二维码和主扫'},{id: '6',text: '二维码和被扫'},{id: '7',text: '全支持'}],
        ...
        setupSingleVal: function () {
            ...
            this.$singleInput.select2({ data: this.select2Data, width: 150, placeholder: ' - 扫码模式 - '});
...
// icon-minus-sign
    ...
    var CreditSupp = AbstarctField.extend({
        label: '是否支持信用卡',
        name: 'credit_supp',
        extraOprs: ['in', 'not_in'],
        select2Data: [{id: '0', text: '不支持'}, {id: '1', text: '支持'}],
        setMulValue: function (val) {
            this.$mulInput.select2('val', val.split(','));
        },
        setSingleValue: function (val) {
        ...
        setupSingleVal: function () {
            var me = this;
            this.$singleInput = $('<input name="single" class="single-input">').appendTo(this.ui.singleValWrap);
            this.$singleInput.select2({ data: this.select2Data, width: 150, placeholder: ' - 选择是否支持信用卡 - '});
            me.$singleInput.on('change', function () {
                me.$singleInput.trigger('keyup');
            });
        },
    ...
    var fieldMap = [
        ...
        {type:'scan_mode',     label:'扫码模式',fieldView:ScanMode},
        ...
        {type:'amount',      label:'金额',fieldView:FieldAccountView},
        {type:'cmd_type',    label:'交易类型',fieldView:FieldTxnTypeView},
        {type:'total_amt',   label:'总金额',fieldView:FieldTotalAccountView},
        ...
        {type:'credit_supp',  label:'是否支持信用卡',fieldView:CreditSupp},
        {type:'region_code', label:'地区码',fieldView:FieldAreaNoView},
        {type:'tx_time',     label:'时间',fieldView:FieldTimeView},
        ...
        {type:'mod_amt',     label:'通道模型总金额',fieldView:FieldModAmtView},
        {type:'mod_num',     label:'通道模型总笔数',fieldView:FieldModNumView}
    ];
