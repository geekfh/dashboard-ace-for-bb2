 ...
 */
define([
	'app/oms/route/settlement/capacityConfig/common/AbstractAddModelView',
	'app/oms/route/settlement/capacityConfig/common/FieldsetGroup',
	'tpl!app/oms/route/settlement/capacityConfig/edit-add-capacityConfig.tpl',
	...
	var editView = AbstractAddModelView.extend({
		...
		ajaxOptions: function () {
			return {
				type: 'PUT',
				url: url._('route.settlement.capacityConfig.edit', {id: this.model.id})
			};
		},
		events: {
			//'change [name=""]' :  ''
		...
		getFormValues: function() {
			...
			return {
				...
				singleCost:  $el.find('[name="singleCost"]').val(),
				tradeRange:    $el.find('[name="tradeRange"]').val(),
				loaningCost:    $el.find('[name="loaningCost"]').val(),
