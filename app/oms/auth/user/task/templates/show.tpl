<div class="row">
    ...
    <div class="col-sm-4 col-xs-12">
        <button class="takeback btn btn-primary" style="display: none">取回任务</button>
        <div class="not-allow-takeback">取回任务</div>
        <div class="not-allow-toolTips">
    ...
    <div class="">
        <div class="pull-right btn-groups right-btns">
            <button style="display:none;" type="button" class="js-take btn btn-success pull-right">领取该任务</button>
        </div>
    </div>
</div> 
