<div class="innerwrap">
    ...
    <div class="wizard-head row" hidden>
        <div class="caption col-lg-3 col-md-4 col-sm-4 col-xs-12">录入商户</div>
        <div class="wizard-progress col-lg-5 col-md-5 col-sm-6 col-xs-11">
            ...
            <ul class="current-progress nav-progress">
                <li class="step passing active" name="info">
                    <a data-toggle="tab" href="#add-person-mcht-info<%= count %>">
                        <div class="bar"></div>
                ...
                <li class="step " name="pic">
                    <a  data-toggle="tab" href="#add-person-mcht-pic<%= count %>">
                        <div class="bar"></div>
                        <div class="end-point"></div>
                ...
                <li class="step" name="extra">
                    <a  data-toggle="tab" href="#add-person-mcht-extra<%= count %>">
                        <div class="bar"></div>
                        <div class="end-point"></div>
                ...
                <li class="step" name="confirm">
                    <a  data-toggle="tab" href="#add-person-mcht-confirm<%= count %>">
                        <div class="bar"></div>
                        <div class="end-point"></div>
    ...
    <div class="wizard-panel clearfix">
        ...
        <div class="main">
           <div class="tab-content">
                <div class="tab-pane active" id="add-person-mcht-info<%= count %>">
                </div>

                <div class="tab-pane" id="add-person-mcht-pic<%= count %>">
                </div>

                <div class="tab-pane" id="add-person-mcht-extra<%= count %>">
                </div>

                <div class="tab-pane" id="add-person-mcht-confirm<%= count %>">
                </div>
            </div>
        </div>
