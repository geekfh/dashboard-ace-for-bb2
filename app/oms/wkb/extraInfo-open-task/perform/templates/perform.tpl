<div class="row">
    <div class="col-xs-6 col-sm-8 center-wrap">
        <span class="caption">
            开放注册用户补充资料审核
            <i class="icon icon-info-sign js-task-info history-trigger"></i>
        </span>
        <div role="alert" class="div_countDown" hidden>
            <span class="sp_countDown" style="background-color: #fcf8e3; border-color: #fbeed5;"></span>
        </div>
    </div>
