  ...
  'moment.override'
    ...
    var ShowView = Marionette.ItemView.extend({
        ...
        onRender: function () {
            ...
            var mchtInfoView = new BrhInfoView({data: me.brhInfo});
            mchtInfoView.render();

            me.$el.find('.info-board-wrap').html(mchtInfoView.$el);
            me.checkCanITake();
        ...
        goToPerformView: function (data) {
            ...
            require(['app/oms/wkb/branch-task/perform/perform-brh-view'], function (PerformView) {
