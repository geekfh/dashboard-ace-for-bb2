...
define([
    ...
    'app/oms/wkb/mcht-task/PageableMcht'
], function(App, WkbSysApp, TaskApp, PageableMcht) {

    var tasks = new PageableMcht();
    var Controller = {
        ...
        listMchtTasks: function(kw) {
            var me = this;
            require(['app/oms/wkb/mcht-task/task-view'], function(View) {
