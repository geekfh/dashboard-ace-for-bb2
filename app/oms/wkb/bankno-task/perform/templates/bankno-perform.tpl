<div class="row">
    <div class="col-sm-4 col-xs-12 center-wrap" style="margin-left: 190px;">
        <span class="caption">
            银行卡号审核
            <i class="icon icon-info-sign js-task-info history-trigger"></i>
        </span>
    </div>
    <div class="col-sm-12" style="width: 250px !important;">
...
<div role="alert" class="div_countDown">
    <span class="sp_countDown" style="width: 500px; margin-left: 90px; background-color: #fcf8e3; border-color: #fbeed5;padding: 8px;"></span>
</div>
