define([
    'tpl!app/oms/wkb/bankno-task/perform/templates/bankno-show.tpl',
    ...
    var View = Marionette.ItemView.extend({
        className: 'common-task bankno-show bankno-task',
        ...
        goToPerformView: function (data) {
            ...
            require(['app/oms/wkb/bankno-task/perform/bankno-perform'], function (PerformView) {
