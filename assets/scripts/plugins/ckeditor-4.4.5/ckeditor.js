...
(function () {
	...
	CKEDITOR.dom = {};
	(function () {
		var a = [], e = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, f = /</g, d = /"/g, g = /&amp;/g, h = /&gt;/g, m = /&lt;/g, j = /&quot;/g;
		...
		CKEDITOR.tools = {
			...
			extend: function (a) {
				...
				if (typeof(d = arguments[f - 1]) == "boolean")f--; else if (typeof(d = arguments[f - 2]) == "boolean") {
					b = arguments[f - 1];
					f = f - 2
				}
				for (var c = 1; c < f; c++) {
			...
			indexOf: function (a, f) {
				if (typeof f == "function")for (var d = 0, b = a.length; d < b; d++) {
					if (f(a[d]))return d
				} else {
	...
	CKEDITOR.dtd = function () {
		var a = CKEDITOR.tools.extend, e = function (a, f) {
			...
			table: 1,
			ul: 1
		}, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, h = {"#": 1}, m = {
			center: 1,
			dir: 1,
			noframes: 1
		};
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
			...
			for (var b =
				...
				var f = a[c];
				if (e)for (var d = -1, g = 0; g < b.childNodes.length; g++) {
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			removeStyle: function (a) {
				...
				if (!d.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
					...
					for (var d = [], e = 0; e < b.length; e++)if (c)for (var j = 0; j < c.length; j++)d.push([a, b[e], c[j]].join("-")); else d.push([a, b[e]].join("-"));
			...
			getDocumentPosition: function (a) {
				var d = 0, b = 0, c = this.getDocument(), e = c.getBody(), j = c.$.compatMode == "BackCompat";
			...
			copyAttributes: function (a, b) {
				for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
					var m = c[e], j = m.nodeName.toLowerCase(), p;
					if (!(j in b))if (j == "checked" && (p = this.getAttribute(j)))a.setAttribute(j, p); else if (!CKEDITOR.env.ie || this.hasAttribute(j)) {
	...
	(function () {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				var x = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), s = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(p) : d.getNext();
				this._.guardLTR = function (a, b) {
					return (!b || !x.equals(a)) && (!s || !a.equals(s)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			if (a && !this._.guardRTL) {
				var g = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), j = f.type == CKEDITOR.NODE_ELEMENT ? e ? f.getChild(e - 1) : null : f.getPrevious();
			...
			if (this.current)d = this.current[q](false, l, i); else {
				if (a)d.type ==
				CKEDITOR.NODE_ELEMENT && (d = p > 0 ? d.getChild(p - 1) : i(d, true) === false ? null : d.getPreviousSourceNode(true, l, i)); else {
					d = f;
		...
		var j = CKEDITOR.dom.walker.ignored(), p = function (a) {
			var b = {}, c;
	...
	(function () {
		...
		var c = function (a) {
			...
			if (f.type == CKEDITOR.NODE_TEXT) {
				...
				i = true
			} else f = f.getChild(o).getPrevious(); else {
				f = f.append(a.document.createText(""), 1);
				i = true
			}
			var o = f.getParents(), r = e.getParents(), l, q, x;
			for (l = 0; l < o.length; l++) {
				q = o[l];
				x = r[l];
				if (!q.equals(x))break
			}
			for (var s = c, g, j, m, F = l; F < o.length; F++) {
				g =
					o[F];
				...
				for (g = g.getNext(); g;) {
					...
					m = g.getNext();
					if (b == 2)s.append(g.clone(true)); else {
						g.remove();
						b == 1 && s.append(g)
					}
					g = m
			...
			for (c = l; c < r.length; c++) {
				...
				if (!o[c] || g.$.parentNode != o[c].$.parentNode)for (g = g.getPrevious(); g;) {
					...
					m = g.getPrevious();
					if (b == 2)s.$.insertBefore(g.$.cloneNode(true), s.$.firstChild); else {
						g.remove();
		...
		CKEDITOR.dom.range.prototype =
		{
			...
			switch (a) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
						...
						for (; l;) {
							...
							if (l.type == CKEDITOR.NODE_COMMENT)l = l.getPrevious(); else {
								if (l.type == CKEDITOR.NODE_TEXT) {
									...
									(CKEDITOR.env.webkit ? 1 : 0) || b && l.is("br")) && !l.data("cke-bookmark"))if (x && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
									g = l.getText();
									if (d.test(g))l = null; else for (var j = l.$.getElementsByTagName("*"), m = 0, F; F = j[m++];)if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
										l = null;
										break
									}
									l && (s = !!g.length)
					...
					if (s.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(s.substring(j)).length)x = true; else {
						x = !s.getLength();
						if (j == s.getLength()) {
							if (!(l = s.getNext()))k =
								s.getParent()
				...
				case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
					...
					var J, A, E = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), v = null, z = function (a) {
			...
			if (!this.collapsed) {
				var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), f = this.startContainer, e = this.endContainer, o = this.startOffset, g = this.endOffset, i = 1, k = 1;
				if (f && f.type == CKEDITOR.NODE_TEXT)if (o)if (o >= f.getLength())d.setStartAfter(f); else {
					d.setStartBefore(f);
					i = 0
				} else d.setStartBefore(f);
				if (e && e.type == CKEDITOR.NODE_TEXT)if (g)if (g >= e.getLength())d.setEndAfter(e); else {
					d.setEndAfter(e);
					k = 0
	...
	(function () {
		...
		var d = /^[\r\n\t ]+$/, g = CKEDITOR.dom.walker.bookmark(false, true), h = CKEDITOR.dom.walker.whitespaces(true), m = function (a) {
			return g(a) && h(a)
		}, j = {dd: 1, dt: 1, li: 1};
		a.prototype = {
			getNextParagraph: function (a) {
				...
				for (this._.nextNode =
					...
					if (l)r.type == CKEDITOR.NODE_TEXT && d.test(r.getText()) && (l = 0); else {
						var x = r.getName();
						if (CKEDITOR.dtd.$block[x] && r.getAttribute("contenteditable") == "false") {
							b = r;
							c(this, a, b);
							break
						} else if (r.isBlockBoundary(this.forceBrBreak && !k && {br: 1})) {
							if (x == "br")l = 1; else if (!h && !r.getChildCount() && x != "hr") {
								b = r;
								y = r.equals(o);
								break
							}
					...
					if (h && !i)for (; !r.getNext(m) && !y;) {
						x = r.getParent();
						if (x.isBlockBoundary(this.forceBrBreak && !k && {br: 1})) {
							i = 1;
							l = 0;
							y || x.equals(o);
				...
				if (!b) {
					...
					i = {div: 1, th: 1, td: 1};
					b = b.block;
					if (!b && r && !this.enforceRealBlocks && i[r.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !r.equals(h.root))b = r; else if (!b || this.enforceRealBlocks && b.is(j)) {
	...
	(function () {
		function a(a, b, c, d, f) {
			...
			for (var b = f.elements, f = f.generic, D, c = 0, d = a.length; c < d; ++c) {
				...
				if (e.elements === true || e.elements === null)f[i ? "unshift" : "push"](e); else {
					q = e.elements;
					delete e.elements;
					for (D in q)if (b[D])b[D][i ? "unshift" : "push"](e); else b[D] = [e]
				}
			}
		}
		...
		function p(a) {
			for (var b, c, d, f, e = {}, i = 1, a = J(a); b = a.match(B);) {
				if (c = b[2]) {
					d = u(c, "styles");
					f = u(c, "attrs");
					c = u(c, "classes")
		...
		function y(a, b, d, f) {
			...
			if (f.doCallbacks && a.elementCallbacks) {
				a:for (var l = a.elementCallbacks, B = 0, s = l.length, g; B < s; ++B)if (g = l[B](b)) {
					k = g;
					break a
				}
				if (k)return k
		...
		function l(a, b, c) {
			var d = a.name;
			if (N.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(i()); else {
				...
				b:{
					f = N[b];
					for (var e = 0, q = d.length, o; e < q; ++e) {
						o = d[e];
				...
				if (f) {
					...
					f = a.parent;
					for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", l, q = d.length; q > 0;) {
						o = d[--q];
		...
		function x(a, b) {
			var c = b.getDefinition(), d = c.attributes, f = c.styles, e, i, q, o;
		...
		CKEDITOR.filter.prototype = {
			allow: function (b, c, f) {
				...
				var f = this, e = [], i = this.editor && this.editor.config.protectedSource, q, k = false, B = {
					doFilter: !c,
					doTransform: true,
					doCallbacks: true,
					toHtml: b
				...
				for (var n, a = [], d = E[d || (this.editor ?
					this.editor.enterMode : CKEDITOR.ENTER_P)]; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
				for (; n = a.pop();) {
					c = n.el;
				...
				if (!this.disabled && a) {
					...
					for (f = 0; f < a.length; ++f) {
						...
						for (i = 0; i < b.length; ++i) {
							...
							c.push({check: o == e ? null : o, left: l, right: typeof k == "string" ? R(k) : k})
						}
						b = e;
						d[b] || (d[b] = []);
						d[b].push(c)
			...
			check: function (a, b, c) {
				...
				var i = CKEDITOR.tools.clone(f), o = [], l;
				if (b !== false && (l = this._.transformations[f.name])) {
					for (d = 0; d < l.length; ++d)q(this, f, l[d]);
					w(f)
				}
				y(this, i, o, {doFilter: true, doTransform: b !== false, skipRequired: !c, skipFinalValidation: !c});
				b = o.length > 0 ? false :
		...
		var v = {styles: 1, attributes: 1, classes: 1}, z = {
			styles: "requiredStyles",
			attributes: "requiredAttributes",
			classes: "requiredClasses"
		}, B = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, D = {
			styles: /{([^}]+)}/,
			attrs: /\[([^\]]+)\]/,
			classes: /\(([^\)]+)\)/
		}, G = /^cke:(object|embed|param)$/, aa = /^(object|embed|param)$/, ba = CKEDITOR.filter.transformationsTools = {
			sizeToStyle: function (a) {
				...
				if (typeof b == "string")a.name = b; else {
					var c = b.getDefinition(), d = c.styles, f = c.attributes, e, i, q, o;
					a.name = c.element;
					for (e in f)if (e == "class") {
						c = a.classes.join("|");
						for (q = f[e].split(/\s+/); o = q.pop();)c.indexOf(o) == -1 &&
						a.classes.push(o)
	...
	CKEDITOR.scriptLoader = function () {
		...
		return {
			load: function (b, c, f, d) {
				...
				g && (b = [b]);
				f || (f = CKEDITOR);
				var h = b.length, m = [], j = [], p = function (a) {
	...
	CKEDITOR.resourceManager.prototype = {
		add: function (a, e) {
			...
			for (var c = this.loaded, f = this.registered, d = [], g = {}, h = {}, m = 0; m < a.length; m++) {
				var j = a[m];
				if (j)if (!c[j] && !f[j]) {
	...
	(function () {
		...
		function p(a) {
			...
			CKEDITOR.plugins.load(c.split(","), function (c) {
				...
				a.plugins = c;
				for (var i in c) {
					var o = c[i], k = o.lang, g = null, r = o.requires, A;
					...
					if (k && !a.lang[i]) {
						...
						if (!o.langEntries || !o.langEntries[g])e.push(CKEDITOR.getUrl(o.path + "lang/" + g + ".js")); else {
	...
	(function () {
			...
			function (d, g, h) {
				function m(a) {
					...
					if (o.length > 0)for (var c = 0; c < o.length; c++) {
						var d = o[c], f = d.name, e = CKEDITOR.dtd[f], l = i.name && CKEDITOR.dtd[i.name];
				...
				var n = new CKEDITOR.htmlParser, w = g instanceof CKEDITOR.htmlParser.element ? g : typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment, o = [], r = [], i = w, k = w.name == "textarea", l = w.name == "pre";
				n.onTagOpen = function (d, f, g, h) {
					f = new CKEDITOR.htmlParser.element(d, f);
					if (f.isUnknown && g)f.isEmpty =
						true;
					f.isOptionalClose = h;
					if (a(f))o.push(f); else {
						...
						if (d == "br")r.push(f); else {
							for (; ;) {
								h = (g = i.name) ? CKEDITOR.dtd[g] || (i._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
								if (!f.isUnknown && !i.isUnknown && !h[d])if (i.isOptionalClose)n.onTagClose(g); else if (d in b && g in b) {
									g = i.children;
									(g = g[g.length - 1]) && g.name == "li" || u(g = new CKEDITOR.htmlParser.element("li"), i);
									!f.returnPoint && (f.returnPoint = i);
									i = g
								} else if (d in CKEDITOR.dtd.$listItem && !y(d, g))n.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (g in e && !y(d, g)) {
									!f.returnPoint && (f.returnPoint = i);
									i = i.parent
								} else {
									g in CKEDITOR.dtd.$inline && o.unshift(i);
									if (i.parent)u(i, i.parent, 1); else {
										f.isOrphan = 1;
										break
									}
								} else break
		...
		CKEDITOR.htmlParser.fragment.prototype = {
			type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, add: function (a, b) {
				...
				if (f !== false)for (var c = this.children, e = 0; e < c.length; e++) {
					f = c[e];
	...
	(function () {
		...
		CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
			$: function (b) {
				...
				addRules: function (a, c) {
					var f;
					if (typeof c == "number")f = c; else if (c && "priority"in
						c)f = c.priority;
		...
		a.prototype = {
			add: function (a, c, f) {
				this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: f})
			}, addMany: function (a,
			                      c, f) {
				...
				var f = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, d = Array.prototype.slice.call(arguments, 1), e = this.rules, h = e.length, m, j, p, u;
				for (u = 0; u < h; u++) {
					if (f) {
						m = c.type;
						j = c.name
					...
					if (!(a.nonEditable && !p.options.applyToAll ||
						a.nestedEditable && p.options.excludeNestedEditable)) {
				...
				for (var f = 0, d = this.rules, e = d.length, h; c && f < e; f++) {
					h = d[f];
					!(a.nonEditable && !h.options.applyToAll || a.nestedEditable && h.options.excludeNestedEditable) && (c = c.replace(h.value[0], h.value[1]))
				}
				return c
			}
		}
	...
	(function () {
		function a(a, e) {
				...
				return function (e) {
					if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (l)for (A(l, 1) && i.push(l); l;) {
							if (d(l) && (q = c(l)) && A(q))if ((o = c(q)) && !d(o))i.push(q); else {
								k(r).insertAfter(q);
								q.remove()
							}
							l = l.previous
						...
						if (i = (typeof f == "function" ? f(e) : f) !== false)if (!r && !CKEDITOR.env.needsBrFiller &&
							e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)i = false; else if (!r && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))i = false; else {
							i = b(e);
			...
			var s = {elements: {}}, r = e == "html", v = CKEDITOR.tools.extend({}, l), z;
				...
				return function (b) {
					if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if ("data-cke-bogus"in e || "data-cke-eol"in
							...
							var i = c(b);
							!e && d(b.parent) ? g(b.parent, k(a)) : d(e) && (i && !d(i)) && k(a).insertBefore(e)
						}
					}
				}
			}(r);
		...
		function j(a) {
			return a.replace(R, function (a, b, c) {
				return "<" + b + c.replace(N, function (a, b) {
		...
		var o = /(?:&nbsp;|\xa0)$/, r = "{cke_protected}", i = CKEDITOR.dtd, k = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], l = CKEDITOR.tools.extend({}, i.$blockLimit, i.$block), q = {
			elements: {
				input: h,
				textarea: h
			}
		}, x = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, s = {
			elements: {
				embed: function (a) {
					var b = a.parent;
					if (b && b.name == "object") {
	...
	(function () {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
				...
				var d = this, e, h, b = d.getFilterContext(b);
	...
	(function () {
		...
		function b(a) {
			var b = a.name, d = a.element, e = a.elementMode,
				h = a.fire("uiSpace", {space: "top", html: ""}).html, m = a.fire("uiSpace", {
					space: "bottom",
					html: ""
				}).html, j = new CKEDITOR.template('<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir="{langDir}" lang="{langCode}" role="application"' + (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : "") + ">" + (a.title ? '<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>' : "") + '<{outerEl} class="cke_inner cke_reset" role="presentation">{topHtml}<{outerEl} id="{contentId}" class="cke_contents cke_reset" role="presentation"></{outerEl}>{bottomHtml}</{outerEl}></{outerEl}>'),
		...
		CKEDITOR.editor.prototype.setMode = function (a, b) {
			...
			if (!(a == d.mode || !e || !e[a])) {
				...
				if (d.mode) {
					var h = d.checkDirty(), e = d._.previousModeData, m, j = 0;
		...
		CKEDITOR.editor.prototype.resize = function (a, b, d, e) {
			var h = this.container, m = this.ui.space("contents"), j = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? this.container.getFirst(function (a) {
	...
	(function () {
		function a(a) {
			var b = a.editor, d = a.data.path, f = d.blockLimit, l = a.data.selection, q = l.getRanges()[0], x;
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			base: CKEDITOR.dom.element, $: function (a, b) {
				...
				focus: function () {
					...
					if (!b) {
						var e = /\n{2}/g;
						if (e.test(a))var f = "<" + c + ">", g = "</" + c + ">", a = f + a.replace(e, function () {
								return g + f
							}) + g
					}
					a = a.replace(/\n/g, "<br>");
					...
					var g, s;
					if (f)for (; (g = b.getCommonAncestor(0, 1)) && (s = CKEDITOR.dtd[g.getName()]) && (!s || !s[e]);)if (g.getName()in
						CKEDITOR.dtd.span)b.splitElement(g); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
						b.setStartBefore(g);
						b.collapse(true);
						g.remove()
					...
					this.attachListener(a, "beforeGetData", function () {
						var b = this.getData();
						this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(u, function (a, b) {
							return b
						}));
						a.setData(b,
							null, 1)
					...
					if (!this.is("textarea")) {
						...
						this.attachListener(a, "key", function (b) {
							...
							if (c in l) {
								var b = a.getSelection(), f, i = b.getRanges()[0], k = i.startPath(), g, h, j, c = c == 8;
								if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (f = b.getSelectedElement()) || (f = d(b))) {
									...
									a.fire("saveSnapshot");
									e = 1
								} else if (k.blockLimit && k.blockLimit.is("td") && (h = k.blockLimit.getAscendant("table")) && i.checkBoundaryOfElement(h, c ? CKEDITOR.START : CKEDITOR.END) && (j =
										h[c ? "getPrevious" : "getNext"](t))) {
									a.fire("saveSnapshot");
									i["moveToElementEdit" + (c ? "End" : "Start")](j);
							...
							"key", function (b) {
								...
								if (b in l) {
									...
									if (d.collapsed) {
										...
										e = b.block;
										k = c.endPath().block;
										if (!e || !k || e.equals(k))b = false; else {
											a.fire("saveSnapshot");
		...
		var p = CKEDITOR.dom.walker.bogus(), u = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
		...
		var n = function () {
			...
			var h = CKEDITOR.dtd, s = {
				...
				dl: 1,
				blockquote: 1
			}, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, p = CKEDITOR.tools.extend({}, h.$inline);
			delete p.br;
			return function (s, n, u) {
				var t = s.editor, A = t.getSelection().getRanges()[0], E = false;
				if (n == "unfiltered_html") {
					n = "html";
					E = true
				}
				if (!A.checkReadOnly()) {
					var v = (new CKEDITOR.dom.elementPath(A.startContainer, A.root)).blockLimit || A.root, n = {
						type: n,
						dontFilter: E,
						editable: s,
						editor: t,
						...
						mergeCandidates: [],
						zombies: []
					}, t = n.range, E = n.mergeCandidates, z, B, D, G;
					...
					if (!t.collapsed) {
						var v = D.block || D.blockLimit, y = t.getCommonAncestor();
					...
					if (z = u) {
						...
						if (/^\s+|\s+$/.test(u) && "span"in CKEDITOR.dtd[G])var w = '<span data-cke-marker="1">&nbsp;</span>', u = w + u + w;
					...
					if (z) {
						...
						for (q(B, H); z < B.length; z++) {
							...
							if (C = D.isLineBreak) {
								...
								if (D.hasBlockSibling)C = 1; else {
									P = C.startContainer.getAscendant(h.$block, 1);
									if (!P || !P.is({div: 1, p: 1}))C = 0; else {
										Y = P.getPosition(L);
										if (Y == CKEDITOR.POSITION_IDENTICAL || Y == CKEDITOR.POSITION_CONTAINS)C = 0; else {
											L = C.splitElement(P);
							...
							if (C)E = z > 0; else {
								...
								if (!D.isBlock && g(n.editor, C.block, C.blockLimit) && (S = n.editor.activeEnterMode != CKEDITOR.ENTER_BR && n.editor.config.autoParagraph !==
									false ? n.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false)) {
									S = w.createElement(S);
									S.appendBogus();
									H.insertNode(S);
								...
								if (D.lastNotAllowed && z < B.length - 1) {
									(U = y ? v : U) && H.setEndAt(U, CKEDITOR.POSITION_AFTER_START);
									t = 0
								}
								H.collapse()
							}
	...
	(function () {
		...
		CKEDITOR.on("instanceCreated", function (b) {
			...
			f.on("contentDom", function () {
				...
				var i = f.document, k = CKEDITOR.document, g = f.editable(), h = i.getBody(),
				...
				if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
					...
					g.attachListener(i.getDocumentElement(), "mouseup", function () {
						v && e.call(f);
						v = 0
					})
				} else g.attachListener(CKEDITOR.env.ie ? g : i.getDocumentElement(), "mouseup", e, f);
				CKEDITOR.env.webkit && g.attachListener(i, "keydown", function (a) {
		...
		CKEDITOR.dom.selection = function (a) {
			...
			"None" && this.document.getActive().equals(a) || c.type == "Caret" && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && h(a, c); else if (CKEDITOR.env.gecko)c && (this.document.getActive().equals(a) && c.anchorNode && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && h(a, c, true); else if (CKEDITOR.env.ie) {
				...
				if (w)c.type == "None" && (b && b.equals(this.document.getDocumentElement())) && h(a, null, true); else {
			...
			getNative: function () {
				...
				var a = w ? function () {
					...
					var b = function (b, c) {
						...
						for (var e = d.children, f, i, g = b.duplicate(), l = 0, h = e.length - 1, A = -1, j, v; l <= h;) {
							A = Math.floor((l + h) / 2);
							f = e[A];
							g.moveToElementText(f);
							j = g.compareEndPoints("StartToStart",
								b);
							if (j > 0)h = A - 1; else if (j < 0)l = A + 1; else return {container: d, offset: a(f)}
						}
						...
						return {container: v, offset: j > 0 ? -g : v.nodeValue.length + g}
					};
					return function () {
	...
	(function () {
		...
		function e(b) {
			...
			if (b.collapsed) {
				...
				if (!j) {
					var t = b.getCommonAncestor(), j = a(l, t), t = a(m, t);
				...
				for (p.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (p = 0); p;) {
					...
					if (p.equals(m)) {
						...
						var r = p.type == CKEDITOR.NODE_ELEMENT ? p.getName() : null, t = r && p.getAttribute("contentEditable") == "false", u = r && p.getAttribute("data-nostyle");
						if (r && p.data("cke-bookmark")) {
							p =
								p.getNextSourceNode(true);
							continue
						}
						if (t && i && CKEDITOR.dtd.$block[r])for (var s = p, w = c(s), x = void 0, F = w.length, M = 0, s = F && new CKEDITOR.dom.range(s.getDocument()); M < F; ++M) {
							var x = w[M], X = CKEDITOR.filter.instances[x.data("cke-filter")];
							if (X ? X.check(this) : 1) {
						...
						if (w)if ((w = p.getParent()) && ((w.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(w))) {
							...
							if (r == CKEDITOR.NODE_TEXT || t || r == CKEDITOR.NODE_ELEMENT && !p.getChildCount()) {
								for (var r = p, W; (j = !r.getNext(N)) && (W = r.getParent(), k[W.getName()]) && (W.getPosition(l) | J) == J && (!g.childRule || g.childRule(W));)r = W;
								q.setEndAfter(r)
							}
		...
		}, s =
		{
			...
			audio: 1,
			video: 1
		}, M = /\s*(?:;\s*|$)/, R = /#\((.+?)\)/g, N = CKEDITOR.dom.walker.bookmark(0, 1), F = CKEDITOR.dom.walker.whitespaces(1);
	...
	(function () {
		...
		CKEDITOR.dom.elementPath = function (b, f) {
			var d = null, g = null, h = [], m = b, j, f = f || b.getDocument().getBody();
	...
	(function () {
		function a(a, c, e) {
			var d = a.serializable, g = c[e ? "endContainer" : "startContainer"], h = e ? "endOffset" : "startOffset", m = d ? c.document.getById(a.startNode) : a.startNode, a = d ? c.document.getById(a.endNode) : a.endNode;
						...
						if (h && a.length > 1) {
							...
							if (g)for (var j = 0; a[d + j + 1];) {
								...
								1].startNode); ;) {
									...
									if (p.equals(m))g = 1; else if (c(m) || m.type == CKEDITOR.NODE_ELEMENT && m.isBlockBoundary())continue;
									break
								}
								if (!g)break;
								j++
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			getUiColor: function () {
				...
				return (this.setUiColor = function (a) {
					var c = CKEDITOR.skin.chameleon, d = [[m, a]];
					this.uiColor = a;
					f([b], c(this,
						"editor"), d);
					f(h, c(this, "panel"), d)
	...
	(function () {
		...
		function r(b) {
			for (var b =
				b.getSelection().getRanges(!0), d = b.length - 1; 0 < d; d--)b[d].deleteContents();
			return b[0]
		}
	...
	(function () {
		function k(a) {
			...
			this.setup();
			CKEDITOR.env.ie && (b.getDocumentElement().addClass(b.$.compatMode), e.config.enterMode != CKEDITOR.ENTER_P && this.attachListener(b, "selectionchange", function () {
				var a = b.getBody(), c = e.getSelection(), d = c && c.getRanges()[0];
				d && (a.getHtml().match(/^<p>(?:&nbsp;|<br>)<\/p>$/i) && d.startContainer.equals(a)) &&
				setTimeout(function () {
			...
			(CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == e.document.$.compatMode) && this.attachListener(this,
				"keydown", function (a) {
			...
			init: function (a) {
				...
				a.addMode("wysiwyg", function (e) {
					...
					CKEDITOR.env.webkit && (c = function () {
						...
						g.removeStyle("width");
						d.show()
					}, d.setCustomData("onResize", c), CKEDITOR.document.getWindow().on("resize",
						c));
					a.fire("ariaWidget", d)
				})
			}
		...
		var j = CKEDITOR.tools.createClass({
			$: function (a) {
				...
				setData: function (a, e) {
					var b =
						this.editor;
					if (e)this.setHtml(a), b.fire("dataReady"); else {
	...
	(function () {
		...
		function l(a, b) {
			return !b || b.equals(a) ? null : w(b) ? b : l(a, b.getParent())
		}
					...
					"drop", function (c) {
						...
						if (d) {
							...
							if ("cke-widget" == e.type && (c.data.preventDefault(), e.editor == b.name && (h = a.instances[e.id]))) {
								a:if (e = c.data.$, d = b.createRange(), c.data.testRange)d = c.data.testRange; else if (document.caretRangeFromPoint)c = b.document.$.caretRangeFromPoint(e.clientX, e.clientY), d.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), d.collapse(!0); else if (e.rangeParent)d.setStart(CKEDITOR.dom.node(e.rangeParent),
									e.rangeOffset), d.collapse(!0); else if (document.body.createTextRange)c = b.document.getBody().$.createTextRange(), c.moveToPoint(e.clientX, e.clientY), e = "cke-temp-" + (new Date).getTime(), c.pasteHTML('<span id="' + e + '">​</span>'), c = b.document.getById(e), d.moveToPosition(c, CKEDITOR.POSITION_BEFORE_START), c.remove(); else {
									d = null;
									break a
								}
		...
		function P(a) {
			function b(c) {
				a.focused && B(a.focused, "cut" == c.name)
			}
			...
			b.on("toDataFormat", function (b) {
				...
				b.data.dataValue.forEach(function (c) {
					...
					if ("data-cke-widget-id"in b) {
						if (b = a.instances[b["data-cke-widget-id"]])d = c.getFirst(v), f.push({
							wrapper: c, element: d,
							widget: b, editables: {}
		...
		function I(a) {
			...
			c.on("paste", function (a) {
				a.data.dataValue = a.data.dataValue.replace(X, W)
			});
		...
		function Z(a) {
			if (a.draggable) {
				...
				c ? d = c.findOne("img") : (c = new CKEDITOR.dom.element("span", b.document), c.setAttributes({
					...
					src: CKEDITOR.tools.transparentImageData, width: m, title: b.lang.widget.move, height: m
				...
				if (a.inline)d.on("dragstart", function (c) {
		...
		o.prototype = {
			MIN_SELECTION_CHECK_INTERVAL: 500, add: function (a, b) {
				...
				if (d)if ("string" == typeof d)for (d =
					                                    d.split(","); d.length;)this._.upcasts.push([c.upcasts[d.pop()], c.name]); else this._.upcasts.push([d, c.name]);
				...
				if ((a = a.getFirst()) && r(a))this.editor.insertElement(a), a = this.getByElement(a), a.ready = !0, a.fire("ready"), a.focus()
				...
				return function (b, c) {
					...
					if (!c && !d) {
						...
						do b = b.getParent(); while (b && !b.equals(e) && !(d = b.is(a) && b.data("cke-widget-id")))
					}
		...
		k.prototype = {
			addClass: function (a) {
				...
				return c && c.is(CKEDITOR.dtd.$editable) ?
					(c = new q(this.editor, c, {filter: u.call(this.repository, this.name, a, b)}), this.editables[a] = c, c.setAttributes({
						contenteditable: "true",
						"data-cke-widget-editable": a,
						"data-cke-enter-mode": c.enterMode
					}), c.filter && c.data("cke-filter", c.filter.id), c.addClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), b.pathName && c.data("cke-display-name", b.pathName), this.editor.focusManager.add(c), c.on("focus", H, this), CKEDITOR.env.ie && c.on("blur", G, this), c.setData(c.getHtml()), !0) : !1
			}, isInited: function () {
				...
				if (!c || !(b.x == c.x && b.y == c.y))c = a.checkDirty(), a.fire("lockSnapshot"), this.dragHandlerContainer.setStyles({
					top: b.y +
					"px", left: b.x + "px"
		...
		var X = RegExp('^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?</span>([\\s\\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?</span>(?:</(?:div|span)>)?(?:</(?:div|span)>)?$'), ea = {
			37: 1,
			38: 1,
			39: 1,
			40: 1,
		...
		(function () {
			...
			function b(a, b, e) {
				return !e || !this.checkElement(a) ? !1 : (a = e.widgets.getByElement(a, !0)) && a.checkStyleActive(this)
			}
			...
			CKEDITOR.style.addCustomHandler({
				type: "widget", setup: function (a) {
					...
					a instanceof CKEDITOR.editor && this.checkApplicable(a.elementPath(), a) && a.widgets.focused.applyStyle(this)
				}, remove: function (a) {
				...
				checkElementMatch: b, checkElementRemovable: b, checkElement: function (a) {
					return !r(a) ? !1 : (a = a.getFirst(p)) && a.data("widget") == this.widget
				}, buildPreview: function (a) {
	...
	(function () {
			...
			return {
				...
				init: function () {
					...
					g && this.wrapper.contains(g) && (this.parts.link =
						g);
					e.align || (f ? (this.element.hasClass(f[0]) ? e.align = "left" : this.element.hasClass(f[2]) && (e.align = "right"), e.align ? this.element.removeClass(f[n[e.align]]) : e.align = "none") : (e.align = this.element.getStyle("float") || c.getStyle("float") || "none", this.element.removeStyle("float"), c.removeStyle("float")));
					...
					this.setData(e);
					a.filter.checkFeature(this.features.dimension) && D(this);
		...
		function E(a) {
			...
			return function (a, g) {
				...
				if (!a.attributes["data-cke-realelement"]) {
					if (b(a)) {
						if ("div" == c && (h = a.getFirst("figure")))a.replaceWith(h),
							a = h;
						g.align = "center";
		...
		function F(a) {
			...
			return function (a) {
				...
				d &&
				"none" != d && (c = CKEDITOR.tools.parseCssText(g.style || ""), "center" == d && "figure" == a.name ? a = a.wrapWith(new CKEDITOR.htmlParser.element("div", b ? {"class": b[1]} : {style: "text-align:center"})) : d in{
					left: 1,
					right: 1
		...
		function D(a) {
			...
			g.on("mousedown", function (c) {
				...
				var h = a.parts.image, w = "right" == a.data.align ? -1 : 1, i = c.data.$.screenX, H = c.data.$.screenY, k = h.$.clientWidth, n = h.$.clientHeight, r = k / n, l = [], o = "cke_image_s" + (!~w ? "w" : "e"), x, p, q, v, t, m, u;
				b.fire("saveSnapshot");
		...
		function J(a) {
			a.plugins.link && (CKEDITOR.on("dialogDefinition", function (b) {
				...
				var e =
					i(a);
				e && (this.setState(e.data.link || e.wrapper.getAscendant("a") ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED), b.cancel())
			}))
		}
		...
		function B(a) {
			...
			b ? (a.div.classes = b[1], a.p.classes = a.div.classes, a.img.classes = b[0] + "," + b[2], a.figure.classes += "," + a.img.classes) : (a.div.styles =
				"text-align", a.p.styles = "text-align", a.img.styles = "float", a.figure.styles = "float,display");
			return a
		}
		...
		var z = '<img alt="" src="" />', K = new CKEDITOR.template('<figure class="{captionedClass}">' + z + "<figcaption>{captionPlaceholder}</figcaption></figure>"),
			n = {left: 0, center: 1, right: 2}, G = /^\s*(\d+\%)\s*$/i;
		...
		CKEDITOR.plugins.image2 = {
			stateShifter: function (a) {
				...
				var f = a.document, g = a.config.image2_alignClasses, d = a.config.image2_captionedClass, c = a.editable(), h = ["hasCaption", "align", "link"], i = {
					align: function (c, d, e) {
						...
						if (b.changed.link) {
							var e = b.element.is("img") ? b.element : b.element.findOne("img"),
								g = b.element.is("a") ? b.element : b.element.findOne("a"), h = b.element.is("a") && !d || b.element.is("img") && d, i;
							h && b.deflate();
	...
	(function () {
		...
		if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,horizontalrule,312,,indent-rtl,336,,indent,360,,outdent-rtl,384,,outdent,408,,anchor-rtl,432,,anchor,456,,link,480,,unlink,504,,bulletedlist-rtl,528,,bulletedlist,552,,numberedlist-rtl,576,,numberedlist,600,,maximize,624,,pastetext-rtl,648,,pastetext,672,,pastefromword-rtl,696,,pastefromword,720,,removeformat,744,,source-rtl,768,,source,792,,specialchar,816,,scayt,840,,table,864,,redo-rtl,888,,redo,912,,undo-rtl,936,,undo,960,,spellchecker,984,,image,1008,,preview-rtl,1032,,preview,1056,', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,horizontalrule,312,auto,indent-rtl,336,auto,indent,360,auto,outdent-rtl,384,auto,outdent,408,auto,anchor-rtl,432,auto,anchor,456,auto,link,480,auto,unlink,504,auto,bulletedlist-rtl,528,auto,bulletedlist,552,auto,numberedlist-rtl,576,auto,numberedlist,600,auto,maximize,624,auto,pastetext-rtl,648,auto,pastetext,672,auto,pastefromword-rtl,696,auto,pastefromword,720,auto,removeformat,744,auto,source-rtl,768,auto,source,792,auto,specialchar,816,auto,scayt,840,auto,table,864,auto,redo-rtl,888,auto,redo,912,auto,undo-rtl,936,auto,undo,960,auto,spellchecker,984,auto,image,1008,auto,preview-rtl,1032,auto,preview,1056,auto', 'icons.png');
	})();
