...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.applyClass = 'btn-success pull-left';
            this.cancelClass = 'btn-default pull-right';
            ...
            // >>>override 为了不让起始日期和结束日期的dom交换位置
            // if (this.opens == 'right') {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                // override html += '<th class="prev available"><i class="fa fa-arrow-left icon-arrow-left glyphicon glyphicon-arrow-left"></i></th>';
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                // override html += '<th class="next available"><i class="fa fa-arrow-right icon-arrow-right glyphicon glyphicon-arrow-right"></i></th>';
